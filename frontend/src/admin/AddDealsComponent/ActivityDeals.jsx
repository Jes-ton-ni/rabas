...
const ActivityDeals = () => {
  ...
  const sampleActiveDeals = [
    { id: '1', activityId: '401', discount: 20, expirationDate: '2023-12-31' },
  ];

  const sampleExpiredDeals = [
    { id: '2', activityId: '402', discount: 10, expirationDate: '2023-01-01' },
  ];
            ...
            {sampleActiveDeals.map(deal => (
              <div key={deal.id} className="bg-white shadow-md rounded-lg p-4 hover:shadow-xl transition-shadow duration-300">
                <div className="flex flex-col mb-2">
                  <span className="font-bold text-gray-800">{activities.find(activity => activity.id === deal.activityId)?.activityName || 'Sample Activity'}</span>
