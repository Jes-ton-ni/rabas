...
import { addRestaurantDeal, deleteRestaurantDeal, updateRestaurantDeal } from '@/redux/restaurantDealsSlice';
...
const RestaurantDeals = () => {
  ...
  const handleAddDeal = () => {
    ...
    if (editingDeal) {
      ...
      dispatch(addRestaurantDeal(selectedService, discountValue, expirationDate, newDeal.hasBookingOption));
      Swal.fire({
        title: 'Success!',
    ...
    <div className="p-8 bg-gray-50 min-h-screen w-full">
      <div className="grid grid-cols-2 gap-8 max-w-7xl mx-auto">
            ...
            {activeDeals.map(deal => (
              <div key={deal.id} className="bg-white shadow-md rounded-lg p-4">
                <div className="flex flex-col mb-2">
                  <span className="font-bold">{services.find(service => service.id === deal.serviceId)?.serviceName}</span>
        ...
        <div className="bg-white shadow-lg rounded-lg p-6">
          ...
          />
          <Input
            placeholder="Pricing Unit (e.g., per meal)"
            name="pricingUnit"
            ...
            {newActiveDeals.map(deal => (
              <div key={deal.name} className="bg-white shadow-md rounded-lg p-4">
                ...
                <div className="flex flex-col mb-2">
                  ...
                  <span className="text-sm text-gray-600">Price: {deal.price} {deal.pricingUnit}</span>
                  <span className="text-sm text-gray-600">Booking Option: {deal.hasBookingOption ? "Yes" : "No"}</span>
                </div>
                <div className="flex justify-between mt-4">
